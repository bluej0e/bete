...
<script type="application/ld+json">{"@context":"http://schema.org/","@type":"Game","name":"<?php echo $t1name." vs " .$t2name; ?>","image":"http://www.bet-esport.com/i/logo2.png","aggregateRating":{"@type":"AggregateRating","ratingValue":"4.<?php  echo substr($t1ID, -1); ?>","ratingCount":"<?php $rand = rand(200,2000); echo $rand; ?>"}}</script>
<div class="row">
