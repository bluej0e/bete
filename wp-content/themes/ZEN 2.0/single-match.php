...
<script>
	dataLayer.push({'gameType': '<?php echo $gametype; ?>', 'pageType':'<?php echo get_post_type(); ?>', 'tournamentName': '<?php echo $tournament;?>','team1': '<?php echo $t1name; ?>','team2': '<?php echo $t2name; ?>' });
</script>
