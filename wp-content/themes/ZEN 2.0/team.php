...
?>   
							...
							<div class="team">
                                <img alt="<?php $values = get_post_custom_values("teamcode"); echo $values[0]; ?>" src="https://www.bete-sport.com/i/<?php $values = get_post_custom_values("teamcode"); echo $values[0]; ?>.png" />
                    </div>
							<div class="teaminfo">
								<h1><?php echo $teamname ?></h1>
								<h3>
                                    <img pad src="https://www.bete-sport.com/i/flags/48/<?php echo $country; ?>-flag.png"/> 
                                    <a href="https://www.bete-sport.com/<?php echo $gametype; ?>/">
                                        <img  src="https://www.bete-sport.com/i/<?php echo $gametype; ?>_300.png"/>
                                    </a>
                                </h3>
						...
						while ( $players->have_posts() ) {		
							...
							<a href="<?php the_permalink(); ?>">
								...
								<table id="players"><tr><td width="120" height="145" align="center" valign="top">
									...
									?>
									<span class="textbox">
										<img width="16px"  src="https://www.bete-sport.com/i/<?php echo $gametype ?>-50.png"/> 
										<img width="16px"  src="https://www.bete-sport.com/i/<?php $values = get_post_custom_values("teamcode"); echo $values[0]; ?>-32x32.png"/> 
										<img width="16px"  src="https://www.bete-sport.com/i/flags/32/<?php $values = get_post_custom_values("fullcountryname"); echo $values[0]; ?>-flag.png"/>
